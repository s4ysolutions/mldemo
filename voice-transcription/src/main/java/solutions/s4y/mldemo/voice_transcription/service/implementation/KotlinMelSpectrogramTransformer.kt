...
import solutions.s4y.mldemo.voice_transcription.service.dependencies.IMelSpectrogramTransformer
...
/**
 * https://github.com/farmaker47/Talk_and_execute/blob/6ace4e452d40c018af55f148d1e9ec83234849f8/app/src/main/java/com/example/talkandexecute/utils/WhisperUtil.kt#L125
 * Mel spectrogram provider for whisper
 * Possible can be too slow and needed to be implemented in C++ for better performance
 */
class KotlinMelSpectrogramTransformer: IMelSpectrogramTransformer {
    companion object {
    ...
    private val nThreads = (Runtime.getRuntime().availableProcessors() - 1).coerceAtLeast(1)
